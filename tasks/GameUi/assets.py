...
class GameUiAssets: 
	...
	# 娱乐区域动画跳过
	I_ENTERTAINMENT_SKIP = RuleImage(roi_front=(1148,39,77,22), roi_back=(1143,34,87,32), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_entertainment_skip.png")
	# 娱乐区域页面标志
