...
extension HomeDashboardStartupX on HomeDashboardController {
  ...
  Future<void> _refreshScriptsAfterConnected({
    ...
    // Keep the startup guard active until every configured launch has been
    // dispatched, so changing the backend cannot redirect the remaining ones.
    await _scriptService.autoRunScript();
  }
