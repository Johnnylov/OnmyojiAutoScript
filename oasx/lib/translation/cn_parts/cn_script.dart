...
final Map<String, String> _cn_script = {
  'device_id': '稳定设备标识',
  'device_id_help': '同一台模拟器使用多个配置时填写相同标识；留空时按连接地址识别。',
  'fair_weight': '执行份额',
  'fair_weight_help': '只在公平调度中生效。同一设备上，数值越大，任务可获得的执行时间份额越多；范围 0.01 至 100。',
  'estimated_batch_seconds': '预计批次耗时（秒）',
  'estimated_batch_seconds_help': '预计运行到下一个安全位置所需时间。到达目标时只请求安全让出，不会在战斗中强制中断。',
  'real_deadline': '活动截止时间',
  'real_deadline_help': '到期后自动取消该任务的启用勾选，保留截止时间。运行中的任务在安全位置结束；不支持中途结束的任务会完成本次执行。取消此处勾选后不限制截止时间。',
  'deadline_at': '活动截止时间',
  'deadline_at_help': '启用后选择活动结束的日期和时间；取消勾选后不限制截止时间。',
  I18n.device: '模拟器设置',
  I18n.error: '出错设置',
